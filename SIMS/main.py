...
main.title("Store Invoice Management System - Mini Project")
main.resizable(0, 0)
def Exit():
...
label2 = Label(main)
label2.place(relx=0.24,rely=0)
label2.configure(text=" STORE INVOICE MANAGEMENT SYSTEM ", font="-family {Podkova} -size 28", bg="white")
label2.configure(relief="ridge")
label2.configure(foreground="#ffffff")
label2.configure(background="#D2463E")

button1 = Button(main)
button1.place(relx=0.3, rely=0.425, width=146, height=90)
...
button2 = Button(main)
button2.place(relx=0.6, rely=0.425, width=146, height=90)
