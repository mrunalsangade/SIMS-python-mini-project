...
class login_page:
    def __init__(self, top=None):
        ...
        # Add heading of EMPLOYEE LOGIN
        heading_label = Label(root, text="EMPLOYEE LOGIN", font="-family {Poppins} -size 20")
        heading_label.place(relx=0.49, rely=0.1, anchor="center")

        # Add label for username
        username_label = Label(root, text="Username:",background="#D2463E", foreground="#ffffff", font="-family {Poppins} -size 12")
        username_label.place(relx=0.273, rely=0.273)
        ...
        password_label = Label(root, text="Password:",background="#D2463E", foreground="#ffffff", font="-family {Poppins} -size 12")
        password_label.place(relx=0.273, rely=0.384)
...
class bill_window:
    def __init__(self, top=None):
        ...
        billing_label = Label(biller, text="BILLING SYSTEM")
        billing_label.place(relx=0.4, rely=0.07, width=300)
        billing_label.configure(font="-family {Poppins} -size 24")
        billing_label.configure(foreground="#ffffff")
        billing_label.configure(background="#D2463E")

        self.message = Label(biller)
        self.message.place(relx=0.031, rely=0.055, width=76, height=23)
        ...
        self.customer_details_label = Label(biller, text="Customer Details")
        self.customer_details_label.place(relx=0.02, rely=0.17)
        self.customer_details_label.configure(font="-family {Poppins} -size 12")
        self.customer_details_label.configure( background="white", foreground="brown")

        self.name_label = Label(top, text="Customer Name")
        self.name_label.place(relx=0.42, rely=0.23)
        self.name_label.configure(font="-family {Poppins} -size 12", bg="white")

        self.contact_label = Label(top, text="Contact Number")
        self.contact_label.place(relx=0.7, rely=0.23)
        self.contact_label.configure(font="-family {Poppins} -size 12", bg="white")

        self.bill_label = Label(top, text="Bill Number")
        self.bill_label.place(relx=0.035, rely=0.23)
        self.bill_label.configure(font="-family {Poppins} -size 12", bg="white")
        ...
        self.line = Frame(biller, height=1, bg="black")
        self.line.place(relx=0.025, rely=0.29, relwidth=0.95)

        self.products_label = Label(biller, text="Products")
        self.products_label.place(relx=0.02, rely=0.32)
        self.products_label.configure(font="-family {Poppins} -size 12", bg="white", foreground="brown")
        
        self.category_label = Label(biller, text="Category")
        self.category_label.place(relx=0.035, rely=0.37)
        self.category_label.configure(font="-family {Poppins} -size 12", bg="white")

        self.subcategory_label = Label(biller, text="Sub Category")
        self.subcategory_label.place(relx=0.035, rely=0.45)
        self.subcategory_label.configure(font="-family {Poppins} -size 12", bg="white")  

        self.product_label = Label(biller, text="Product")
        self.product_label.place(relx=0.035, rely=0.52)
        self.product_label.configure(font="-family {Poppins} -size 12", bg="white")

        self.quantity_label = Label(biller, text="Quantity", bg="white")
        self.quantity_label.place(relx=0.035, rely=0.60)
        self.quantity_label.configure(font="-family {Poppins} -size 12")
        ...
        self.bill_window_label = Label(biller, text="Bill Window")
        self.bill_window_label.place(relx=0.435, rely=0.31)
        self.bill_window_label.configure(font="-family {Poppins} -size 12", bg="white", foreground="brown")
        ...
        heading_label.place(relx=0.69, rely=0.34, anchor="n")
        
        customer_name_label = Label(top, text="Customer Name:", font="-family {Podkova} -size 10", bg="white")
        customer_name_label.place(relx=0.44, rely=0.45)
        
        contact_number_label = Label(top, text="Contact No:", font="-family {Podkova} -size 10", bg="white")
        contact_number_label.place(relx=0.825, rely=0.45)
        
        bill_number_label = Label(top, text="Bill Number:", font="-family {Podkova} -size 10", bg="white")
        bill_number_label.place(relx=0.438, rely=0.48)
        
        date_label = Label(top, text="Date:", font="-family {Podkova} -size 10", bg="white")
        date_label.place(relx=0.825, rely=0.48)

        product_name_label = Label(top,text="Product Name",font="-family {Podkova} -size 10",bg="white")
        product_name_label.place(relx=0.438, rely=0.53)

        quantity_label = Label(top,text="Quantity",font="-family {Podkova} -size 10",bg="white")
        quantity_label.place(relx=0.65, rely=0.53)

        price_label = Label(top,text="Price",font="-family {Podkova} -size 10",bg="white")
        price_label.place(relx=0.825, rely=0.53)

        self.bill_options_label = Label(biller, text="Bill Options")
        self.bill_options_label.place(relx=0.02, rely=0.83)
        self.bill_options_label.configure(font="-family {Poppins} -size 12", bg="white", foreground="brown")

        self.line2 = Frame(biller, height=1, bg="black")
        self.line2.place(relx=0.025, rely=0.80, relwidth=0.385)
        
        self.line3 = Frame(biller, height=1, bg="black")
        self.line3.place(relx=0.44, rely=0.52, relwidth=0.5)

        self.line4 = Frame(biller, height=1, bg="black")
        self.line4.place(relx=0.44, rely=0.565, relwidth=0.5)

        self.vertical_line = Frame(biller, width=1, bg="black")
        self.vertical_line.place(relx=0.41, rely=0.29, relheight=0.65)
    ...
    def show_qty(self, Event):
        ...
        self.qty_label.configure(anchor="w", borderwidth=1)
    ...
    def wel_bill(self):
        ...
        self.name_message.place(relx=0.52, rely=0.452, width=176, height=30)
        ...
        self.num_message.place(relx=0.88, rely=0.452, width=90, height=30)
        ...
        self.bill_message.place(relx=0.499, rely=0.483, width=176, height=26)
        ...
        self.bill_date_message.place(relx=0.852, rely=0.483, width=90, height=26)
